      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex flex-col justify-between w-full">
          ...
          <div className="flex gap-1 justify-between h-[24px] items-center">
            ...
            {ticket.push > 0 && (
              <span className="leading-none bg-link-color text-white text-[14px] font-medium rounded-full min-w-5 aspect-square shrink-0 flex items-center justify-center">
